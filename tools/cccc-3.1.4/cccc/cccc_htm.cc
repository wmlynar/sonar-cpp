...
//  int javadoc=prjptr->get_count("JAVADOC");  // WOJ
...
void CCCC_Html_Stream::Separate_Modules()
{
  ...
  while(mod_ptr!=NULL)
      ...
      if(trivial_module==FALSE)
	{
	  ...
	  module_html_str.Put_Header_Cell("JAVADOC",5); /* WOJ */
	  module_html_str.Put_Header_Cell("NOCCCC",5); /* WOJ */
	  module_html_str.Put_Header_Cell("MAXNESTING",5); /* WOJ */
...
void CCCC_Html_Stream::Module_Detail(CCCC_Module *module_ptr)
{
  ...
  if(eIter==module_ptr->extent_table.end())
    {
      fstr << "<TR><TD COLSPAN=7>" /* WOJ: colspan +1 */
  ...
  else
    {
	  ...
	  int javadoc=ext_ptr->get_count("JAVADOC"); /* WOJ */
	  ...
	  Put_Metric_Cell(mmvg);
	  Put_Metric_Cell(com);
	  Put_Metric_Cell(javadoc); /* WOJ */
	  Put_Metric_Cell(nocccc); /* WOJ */
	  Put_Metric_Cell(maxnesting); /* WOJ */
	  Put_Metric_Cell(ml_c);
	  Put_Metric_Cell(mm_c);
	  fstr << "</TR>" << endl;
  ...
  fstr << "<TR><TD HEIGHT=12 COLSPAN=9></TD></TR>" << endl;  /* WOJ: colspan +3 */
}
...
void CCCC_Html_Stream::Procedural_Detail(CCCC_Module *module_ptr)
{
  ...
  if(iter==module_ptr->member_map.end())
	...
	{ 
	  ...
	  int javadoc=mem_ptr->get_count("JAVADOC"); /* WOJ */
	  int nocccc=mem_ptr->get_count("NOCCCC"); /* WOJ */
	  int maxnesting=mem_ptr->get_count("MAXNESTING"); /* WOJ */
	  CCCC_Metric mloc(loc,"LOCf");
	  CCCC_Metric mmvg(mvg,"MVGf");
	  CCCC_Metric ml_c(loc,com,"L_C");
	  CCCC_Metric mm_c(mvg,com,"M_C");
	  ...
	  Put_Metric_Cell(mmvg);
	  Put_Metric_Cell(com);
	  Put_Metric_Cell(javadoc);
	  Put_Metric_Cell(nocccc);
	  Put_Metric_Cell(maxnesting);
	  Put_Metric_Cell(ml_c);
	  Put_Metric_Cell(mm_c);
	  fstr << "</TR>" << endl;
