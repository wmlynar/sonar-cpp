...
class ParseUtility {
 ...
 private:
  ...
  enum LexicalCount { tcCOMLINES, tcCODELINES, tcMCCABES_VG, tcJAVADOC, tcNOCCCC, tcNESTING, tcMAXNESTING, tcLINES, tcLAST };
...
class ParseStore
{
 public:
  ...
  //WOJ
  void DecrementCount(LexicalCount lc) { pendingLexicalCounts[lc]--; }
  int GetCount(LexicalCount lc) { return pendingLexicalCounts[lc]; }
  void SetCount(LexicalCount lc, int value) { pendingLexicalCounts[lc] = value; }
